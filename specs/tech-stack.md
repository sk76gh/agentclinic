...
### Recommended: Hono
Hono is chosen over Express/Fastify because:
...
## Testing
- **Vitest** — used for automated validation of business logic, database services, and API routes. It satisfies the requirement for repeatable, machine-verifiable proof that features meet their specifications.
